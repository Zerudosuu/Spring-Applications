...
import { Plus, RefreshCw, Shield, Ticket as TicketIcon, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {activeTab === "tickets" ? (
        ...
        <div className="space-y-4">
          ...
          {UserCard({ currentUserId: user?.id, users, isLoading: usersLoading, roleDrafts, handleRoleSave, handleDeleteUserClick, setRoleDrafts })}
        </div>
      )}
